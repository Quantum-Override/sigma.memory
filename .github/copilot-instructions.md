...
1. ✅ UPDATE WIP (start) — Edit `q-or/wip/sigma-memory.anvl`, mark in-progress, run `wip.py sync`
...
**FR/BR Placement:** FRs and BRs targeting this project MUST live in `sigma.memory/feature-reqs/` or `sigma.memory/bug-reports/`, not in the reporter's project.
